...
-- Projects (Auto-generated from GitHub folders)
INSERT INTO public.projects (slug, title, status, category, tech_stack, period, description, problem, solution, role, features, github_url) VALUES
('ai-in-games', 'ai-in-games', 'Completed', 'AI in Games', '["Custom Tech"]'::jsonb, '2025', 'AI implementation and algorithms for game development.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/ai-in-games'),
('AutoInspect-Cell', 'AutoInspect-Cell', 'Active', 'AI / ML', '["Custom Tech"]'::jsonb, '2026', 'Automated inspection and cellular analysis tool.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/AutoInspect-Cell'),
('autospector', 'AutoSpector', 'Active', 'Web App', '["next","next-auth","@prisma/client","@aws-sdk/client-s3","@google/generative-ai"]'::jsonb, '2026', 'Automated inspection application leveraging generative AI.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/autospector'),
('CueSight', 'CueSight', 'Active', 'AI / ML', '["Custom Tech"]'::jsonb, '2026', 'Computer vision and cue detection application.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/CueSight'),
('dawnbase', 'DawnBase', 'Completed', 'Web App', '["solid-js","socket.io","konva","@prisma/client"]'::jsonb, '2024', 'Collaborative strategy platform with real-time websocket features.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/dawnbase'),
('ecommerce-yk', 'E-Commerce YK', 'Completed', 'Web App', '["Custom Tech"]'::jsonb, '2025', 'E-commerce platform backend and frontend.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/ecommerce-yk'),
('Grafkom2', 'Grafkom2', 'Completed', 'Games', '["Custom Tech"]'::jsonb, '2024', 'Computer graphics assignments and rendering engine.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/Grafkom2'),
('GuidedByTheLight', 'Guided By The Light', 'Completed', 'Games', '["Custom Tech"]'::jsonb, '2023', 'A light-based puzzle/adventure game project.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/GuidedByTheLight'),
('inventary-be', 'Inventory Management (BE)', 'Completed', 'Backend API', '["express","nodejs"]'::jsonb, '2025', 'Backend API for inventory management system.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/inventary-be'),
('inventary-fe', 'Inventory Management (FE)', 'Completed', 'Web App', '["react"]'::jsonb, '2025', 'Frontend for inventory management system.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/inventary-fe'),
('metalMayhem-TankTitans', 'Metal Mayhem: Tank Titans', 'Completed', 'Games', '["Custom Tech"]'::jsonb, '2023', 'Action-packed tank battle game.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/metalMayhem-TankTitans'),
('microboost-android', 'MicroBoost Android', 'Completed', 'Mobile App', '["Kotlin","Android SDK"]'::jsonb, '2025', 'Android application for MicroBoost ecosystem.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/microboost-android'),
('microboost-be', 'MicroBoost Backend', 'Completed', 'Backend API', '["express","@prisma/client","jsonwebtoken","joi"]'::jsonb, '2025', 'Backend services for the MicroBoost platform.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/microboost-be'),
('proyek-ai-client', 'Macanan AI Client', 'Completed', 'AI in Games', '["react","react-redux","@mui/material","socket.io-client"]'::jsonb, '2025', 'Frontend client for Macanan traditional Javanese board game with AI.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek-ai-client'),
('proyek-fpw', 'Omuda E-Commerce', 'Completed', 'Web App', '["@remix-run/react","@google-cloud/storage","radix-ui"]'::jsonb, '2025', 'Full-stack web programming project using Remix.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek-fpw'),
('proyek-softest', 'Software Testing Project', 'Completed', 'Software', '["Python","FastAPI"]'::jsonb, '2025', 'Automated testing and QA project.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek-softest'),
('proyek-ws', 'Web Services Project', 'Completed', 'Backend API', '["express","@prisma/client","mysql2","jsonwebtoken"]'::jsonb, '2024', 'Comprehensive RESTful web service with authentication.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek-ws'),
('proyekbwp', 'BWP Project', 'Completed', 'Web App', '["laravel-vite-plugin","react","@inertiajs/react","flowbite-react"]'::jsonb, '2023', 'Web programming project combining Laravel and React.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyekbwp'),
('ProyekCSA', 'CSA Project (Frontend)', 'Completed', 'Web App', '["react","vite","axios"]'::jsonb, '2025', 'Client Server Architecture project frontend interface.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/ProyekCSA'),
('ProyekCSA-BE', 'CSA Project (Backend)', 'Completed', 'Backend API', '["express","mysql2","@aws-sdk/client-s3","@aws-sdk/client-sqs"]'::jsonb, '2025', 'Backend for CSA leveraging AWS Cloud Services.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/ProyekCSA-BE'),
('proyek_ai_backend', 'AI Backend API', 'Completed', 'AI in Games', '["Python","FastAPI/Flask"]'::jsonb, '2025', 'Backend API serving machine learning models.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek_ai_backend'),
('proyek_ai_macanan', 'Macanan AI Core', 'Completed', 'AI in Games', '["Python"]'::jsonb, '2025', 'Core AI logic and models for the Macanan board game.', 'Needs specific problem description', 'Needs specific solution description', 'Full-Stack Developer', '["Feature 1", "Feature 2"]'::jsonb, 'https://github.com/Rafael-Matthew/proyek_ai_macanan')
